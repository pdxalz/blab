 ...
 *
 * DTS input file:
 *   C:/Users/pdxal/projects/blab/build/zephyr/zephyr.dts.pre
 *
 * Directories with bindings:
 *   C:/ncs/v2.2.0/nrf/dts/bindings, C:/Users/pdxal/projects/blab/dts/bindings, $ZEPHYR_BASE\dts\bindings
 *
...
#define DT_N_S_buttons_S_button_1_STATUS_disabled 1
...
#define DT_N_S_buttons_S_button_1_P_gpios_IDX_0_VAL_pin 28
...
#define DT_N_S_buttons_S_button_2_STATUS_disabled 1
...
#define DT_N_S_buttons_S_button_2_P_gpios_IDX_0_VAL_pin 14
...
#define DT_N_S_buttons_S_button_3_STATUS_disabled 1
...
#define DT_N_S_leds_S_led_0_STATUS_disabled 1
...
#define DT_N_S_leds_S_led_1_STATUS_disabled 1
...
#define DT_N_S_leds_S_led_3_STATUS_disabled 1
...
/* Generic property macros: */
#define DT_N_S_pin_controller_S_uart0_default_S_group1_P_psels {19 /* 0x13 */, 65551 /* 0x1000f */, 131077 /* 0x20005 */, 196615 /* 0x30007 */}
...
#define DT_N_S_pin_controller_S_uart0_default_S_group1_P_psels_IDX_1 65551
...
/*
 * Devicetree node: /zleds
 *
 * Node identifier: DT_N_S_zleds
 *
 * Binding (compatible = gpio-leds):
 *   $ZEPHYR_BASE\dts\bindings\led\gpio-leds.yaml
 *
...
/* Node's full path: */
#define DT_N_S_zleds_PATH "/zleds"

/* Node's name with unit-address: */
#define DT_N_S_zleds_FULL_NAME "zleds"

/* Node parent (/) identifier: */
#define DT_N_S_zleds_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_CHILD_IDX 12

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_FOREACH_CHILD(fn) fn(DT_N_S_zleds_S_led_a) fn(DT_N_S_zleds_S_led_b) fn(DT_N_S_zleds_S_led_c) fn(DT_N_S_zleds_S_led_d) fn(DT_N_S_zleds_S_led_e) fn(DT_N_S_zleds_S_led_f)
#define DT_N_S_zleds_FOREACH_CHILD_SEP(fn, sep) fn(DT_N_S_zleds_S_led_a) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_b) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_c) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_d) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_e) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_f)
#define DT_N_S_zleds_FOREACH_CHILD_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_a, __VA_ARGS__) fn(DT_N_S_zleds_S_led_b, __VA_ARGS__) fn(DT_N_S_zleds_S_led_c, __VA_ARGS__) fn(DT_N_S_zleds_S_led_d, __VA_ARGS__) fn(DT_N_S_zleds_S_led_e, __VA_ARGS__) fn(DT_N_S_zleds_S_led_f, __VA_ARGS__)
#define DT_N_S_zleds_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_a, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_b, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_c, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_d, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_e, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_f, __VA_ARGS__)
#define DT_N_S_zleds_FOREACH_CHILD_STATUS_OKAY(fn) fn(DT_N_S_zleds_S_led_a) fn(DT_N_S_zleds_S_led_b) fn(DT_N_S_zleds_S_led_c) fn(DT_N_S_zleds_S_led_d) fn(DT_N_S_zleds_S_led_e) fn(DT_N_S_zleds_S_led_f)
#define DT_N_S_zleds_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_zleds_S_led_a) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_b) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_c) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_d) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_e) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_f)
#define DT_N_S_zleds_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_a, __VA_ARGS__) fn(DT_N_S_zleds_S_led_b, __VA_ARGS__) fn(DT_N_S_zleds_S_led_c, __VA_ARGS__) fn(DT_N_S_zleds_S_led_d, __VA_ARGS__) fn(DT_N_S_zleds_S_led_e, __VA_ARGS__) fn(DT_N_S_zleds_S_led_f, __VA_ARGS__)
#define DT_N_S_zleds_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_a, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_b, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_c, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_d, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_e, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_zleds_S_led_f, __VA_ARGS__)

/* Node's dependency ordinal: */
#define DT_N_S_zleds_ORD 107

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_SUPPORTS_ORDS \
	108, /* /zleds/led_a */ \
	109, /* /zleds/led_b */ \
	110, /* /zleds/led_c */ \
	111, /* /zleds/led_d */ \
...
/* Existence and alternate IDs: */
#define DT_N_S_zleds_EXISTS 1
#define DT_N_INST_1_gpio_leds DT_N_S_zleds

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_REG_NUM 0
#define DT_N_S_zleds_RANGES_NUM 0
#define DT_N_S_zleds_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_IRQ_NUM 0
#define DT_N_S_zleds_COMPAT_MATCHES_gpio_leds 1
#define DT_N_S_zleds_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_P_compatible {"gpio-leds"}
#define DT_N_S_zleds_P_compatible_IDX_0 "gpio-leds"
#define DT_N_S_zleds_P_compatible_IDX_0_STRING_TOKEN gpio_leds
#define DT_N_S_zleds_P_compatible_IDX_0_STRING_UPPER_TOKEN GPIO_LEDS
#define DT_N_S_zleds_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_zleds_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds, compatible, 0)
#define DT_N_S_zleds_P_compatible_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds, compatible, 0)
#define DT_N_S_zleds_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds, compatible, 0, __VA_ARGS__)
#define DT_N_S_zleds_P_compatible_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds, compatible, 0, __VA_ARGS__)
#define DT_N_S_zleds_P_compatible_LEN 1
#define DT_N_S_zleds_P_compatible_EXISTS 1

/*
 * Devicetree node: /zleds/led_a
 *
 * Node identifier: DT_N_S_zleds_S_led_a
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_a_PATH "/zleds/led_a"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_a_FULL_NAME "led_a"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_a_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_a_CHILD_IDX 0

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_a_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_a_ORD 108

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_a_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_a_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_a_EXISTS 1
#define DT_N_NODELABEL_leda DT_N_S_zleds_S_led_a

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_a_REG_NUM 0
#define DT_N_S_zleds_S_led_a_RANGES_NUM 0
#define DT_N_S_zleds_S_led_a_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_a_IRQ_NUM 0
#define DT_N_S_zleds_S_led_a_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_a_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_VAL_pin 10
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_a_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_a_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_a, gpios, 0)
#define DT_N_S_zleds_S_led_a_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_a, gpios, 0)
#define DT_N_S_zleds_S_led_a_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_a, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_a_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_a, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_a_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_a_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_a_P_label "Left Blue LED"
#define DT_N_S_zleds_S_led_a_P_label_STRING_TOKEN Left_Blue_LED
#define DT_N_S_zleds_S_led_a_P_label_STRING_UPPER_TOKEN LEFT_BLUE_LED
#define DT_N_S_zleds_S_led_a_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_a, label, 0) \
	fn(DT_N_S_zleds_S_led_a, label, 1) \
	fn(DT_N_S_zleds_S_led_a, label, 2) \
	fn(DT_N_S_zleds_S_led_a, label, 3) \
	fn(DT_N_S_zleds_S_led_a, label, 4) \
	fn(DT_N_S_zleds_S_led_a, label, 5) \
	fn(DT_N_S_zleds_S_led_a, label, 6) \
	fn(DT_N_S_zleds_S_led_a, label, 7) \
	fn(DT_N_S_zleds_S_led_a, label, 8) \
	fn(DT_N_S_zleds_S_led_a, label, 9) \
	fn(DT_N_S_zleds_S_led_a, label, 10) \
	fn(DT_N_S_zleds_S_led_a, label, 11) \
	fn(DT_N_S_zleds_S_led_a, label, 12)
#define DT_N_S_zleds_S_led_a_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_a, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 11) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 12)
#define DT_N_S_zleds_S_led_a_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_a, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 11, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_a, label, 12, __VA_ARGS__)
#define DT_N_S_zleds_S_led_a_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_a, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 11, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_a, label, 12, __VA_ARGS__)
#define DT_N_S_zleds_S_led_a_P_label_EXISTS 1

/*
 * Devicetree node: /zleds/led_b
 *
 * Node identifier: DT_N_S_zleds_S_led_b
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_b_PATH "/zleds/led_b"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_b_FULL_NAME "led_b"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_b_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_b_CHILD_IDX 1

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_b_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_b_ORD 109

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_b_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_b_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_b_EXISTS 1
#define DT_N_NODELABEL_ledb DT_N_S_zleds_S_led_b

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_b_REG_NUM 0
#define DT_N_S_zleds_S_led_b_RANGES_NUM 0
#define DT_N_S_zleds_S_led_b_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_b_IRQ_NUM 0
#define DT_N_S_zleds_S_led_b_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_b_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_VAL_pin 12
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_b_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_b_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_b, gpios, 0)
#define DT_N_S_zleds_S_led_b_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_b, gpios, 0)
#define DT_N_S_zleds_S_led_b_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_b, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_b_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_b, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_b_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_b_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_b_P_label "Left Red LED"
#define DT_N_S_zleds_S_led_b_P_label_STRING_TOKEN Left_Red_LED
#define DT_N_S_zleds_S_led_b_P_label_STRING_UPPER_TOKEN LEFT_RED_LED
#define DT_N_S_zleds_S_led_b_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_b, label, 0) \
	fn(DT_N_S_zleds_S_led_b, label, 1) \
	fn(DT_N_S_zleds_S_led_b, label, 2) \
	fn(DT_N_S_zleds_S_led_b, label, 3) \
	fn(DT_N_S_zleds_S_led_b, label, 4) \
	fn(DT_N_S_zleds_S_led_b, label, 5) \
	fn(DT_N_S_zleds_S_led_b, label, 6) \
	fn(DT_N_S_zleds_S_led_b, label, 7) \
	fn(DT_N_S_zleds_S_led_b, label, 8) \
	fn(DT_N_S_zleds_S_led_b, label, 9) \
	fn(DT_N_S_zleds_S_led_b, label, 10) \
	fn(DT_N_S_zleds_S_led_b, label, 11)
#define DT_N_S_zleds_S_led_b_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_b, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 11)
#define DT_N_S_zleds_S_led_b_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_b, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_b, label, 11, __VA_ARGS__)
#define DT_N_S_zleds_S_led_b_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_b, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_b, label, 11, __VA_ARGS__)
#define DT_N_S_zleds_S_led_b_P_label_EXISTS 1

/*
 * Devicetree node: /zleds/led_c
 *
 * Node identifier: DT_N_S_zleds_S_led_c
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_c_PATH "/zleds/led_c"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_c_FULL_NAME "led_c"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_c_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_c_CHILD_IDX 2

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_c_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_c_ORD 110

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_c_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_c_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_c_EXISTS 1
#define DT_N_NODELABEL_ledc DT_N_S_zleds_S_led_c

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_c_REG_NUM 0
#define DT_N_S_zleds_S_led_c_RANGES_NUM 0
#define DT_N_S_zleds_S_led_c_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_c_IRQ_NUM 0
#define DT_N_S_zleds_S_led_c_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_c_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_VAL_pin 16
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_c_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_c_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_c, gpios, 0)
#define DT_N_S_zleds_S_led_c_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_c, gpios, 0)
#define DT_N_S_zleds_S_led_c_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_c, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_c_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_c, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_c_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_c_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_c_P_label "Left Green LED"
#define DT_N_S_zleds_S_led_c_P_label_STRING_TOKEN Left_Green_LED
#define DT_N_S_zleds_S_led_c_P_label_STRING_UPPER_TOKEN LEFT_GREEN_LED
#define DT_N_S_zleds_S_led_c_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_c, label, 0) \
	fn(DT_N_S_zleds_S_led_c, label, 1) \
	fn(DT_N_S_zleds_S_led_c, label, 2) \
	fn(DT_N_S_zleds_S_led_c, label, 3) \
	fn(DT_N_S_zleds_S_led_c, label, 4) \
	fn(DT_N_S_zleds_S_led_c, label, 5) \
	fn(DT_N_S_zleds_S_led_c, label, 6) \
	fn(DT_N_S_zleds_S_led_c, label, 7) \
	fn(DT_N_S_zleds_S_led_c, label, 8) \
	fn(DT_N_S_zleds_S_led_c, label, 9) \
	fn(DT_N_S_zleds_S_led_c, label, 10) \
	fn(DT_N_S_zleds_S_led_c, label, 11) \
	fn(DT_N_S_zleds_S_led_c, label, 12) \
	fn(DT_N_S_zleds_S_led_c, label, 13)
#define DT_N_S_zleds_S_led_c_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_c, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 11) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 12) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 13)
#define DT_N_S_zleds_S_led_c_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_c, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 11, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 12, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_c, label, 13, __VA_ARGS__)
#define DT_N_S_zleds_S_led_c_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_c, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 11, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 12, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_c, label, 13, __VA_ARGS__)
#define DT_N_S_zleds_S_led_c_P_label_EXISTS 1

/*
 * Devicetree node: /zleds/led_d
 *
 * Node identifier: DT_N_S_zleds_S_led_d
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_d_PATH "/zleds/led_d"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_d_FULL_NAME "led_d"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_d_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_d_CHILD_IDX 3

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_d_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_d_ORD 111

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_d_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_d_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_d_EXISTS 1
#define DT_N_NODELABEL_ledd DT_N_S_zleds_S_led_d

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_d_REG_NUM 0
#define DT_N_S_zleds_S_led_d_RANGES_NUM 0
#define DT_N_S_zleds_S_led_d_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_d_IRQ_NUM 0
#define DT_N_S_zleds_S_led_d_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_d_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_VAL_pin 4
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_d_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_d_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_d, gpios, 0)
#define DT_N_S_zleds_S_led_d_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_d, gpios, 0)
#define DT_N_S_zleds_S_led_d_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_d, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_d_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_d, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_d_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_d_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_d_P_label "Right Blue LED"
#define DT_N_S_zleds_S_led_d_P_label_STRING_TOKEN Right_Blue_LED
#define DT_N_S_zleds_S_led_d_P_label_STRING_UPPER_TOKEN RIGHT_BLUE_LED
#define DT_N_S_zleds_S_led_d_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_d, label, 0) \
	fn(DT_N_S_zleds_S_led_d, label, 1) \
	fn(DT_N_S_zleds_S_led_d, label, 2) \
	fn(DT_N_S_zleds_S_led_d, label, 3) \
	fn(DT_N_S_zleds_S_led_d, label, 4) \
	fn(DT_N_S_zleds_S_led_d, label, 5) \
	fn(DT_N_S_zleds_S_led_d, label, 6) \
	fn(DT_N_S_zleds_S_led_d, label, 7) \
	fn(DT_N_S_zleds_S_led_d, label, 8) \
	fn(DT_N_S_zleds_S_led_d, label, 9) \
	fn(DT_N_S_zleds_S_led_d, label, 10) \
	fn(DT_N_S_zleds_S_led_d, label, 11) \
	fn(DT_N_S_zleds_S_led_d, label, 12) \
	fn(DT_N_S_zleds_S_led_d, label, 13)
#define DT_N_S_zleds_S_led_d_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_d, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 11) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 12) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 13)
#define DT_N_S_zleds_S_led_d_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_d, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 11, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 12, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_d, label, 13, __VA_ARGS__)
#define DT_N_S_zleds_S_led_d_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_d, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 11, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 12, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_d, label, 13, __VA_ARGS__)
#define DT_N_S_zleds_S_led_d_P_label_EXISTS 1

/*
 * Devicetree node: /zleds/led_e
 *
 * Node identifier: DT_N_S_zleds_S_led_e
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_e_PATH "/zleds/led_e"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_e_FULL_NAME "led_e"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_e_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_e_CHILD_IDX 4

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_e_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_e_ORD 112

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_e_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_e_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_e_EXISTS 1
#define DT_N_NODELABEL_lede DT_N_S_zleds_S_led_e

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_e_REG_NUM 0
#define DT_N_S_zleds_S_led_e_RANGES_NUM 0
#define DT_N_S_zleds_S_led_e_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_e_IRQ_NUM 0
#define DT_N_S_zleds_S_led_e_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_e_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_VAL_pin 6
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_e_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_e_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_e, gpios, 0)
#define DT_N_S_zleds_S_led_e_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_e, gpios, 0)
#define DT_N_S_zleds_S_led_e_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_e, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_e_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_e, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_e_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_e_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_e_P_label "Right Red LED"
#define DT_N_S_zleds_S_led_e_P_label_STRING_TOKEN Right_Red_LED
#define DT_N_S_zleds_S_led_e_P_label_STRING_UPPER_TOKEN RIGHT_RED_LED
#define DT_N_S_zleds_S_led_e_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_e, label, 0) \
	fn(DT_N_S_zleds_S_led_e, label, 1) \
	fn(DT_N_S_zleds_S_led_e, label, 2) \
	fn(DT_N_S_zleds_S_led_e, label, 3) \
	fn(DT_N_S_zleds_S_led_e, label, 4) \
	fn(DT_N_S_zleds_S_led_e, label, 5) \
	fn(DT_N_S_zleds_S_led_e, label, 6) \
	fn(DT_N_S_zleds_S_led_e, label, 7) \
	fn(DT_N_S_zleds_S_led_e, label, 8) \
	fn(DT_N_S_zleds_S_led_e, label, 9) \
	fn(DT_N_S_zleds_S_led_e, label, 10) \
	fn(DT_N_S_zleds_S_led_e, label, 11) \
	fn(DT_N_S_zleds_S_led_e, label, 12)
#define DT_N_S_zleds_S_led_e_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_e, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 11) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 12)
#define DT_N_S_zleds_S_led_e_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_e, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 11, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_e, label, 12, __VA_ARGS__)
#define DT_N_S_zleds_S_led_e_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_e, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 11, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_e, label, 12, __VA_ARGS__)
#define DT_N_S_zleds_S_led_e_P_label_EXISTS 1

/*
 * Devicetree node: /zleds/led_f
 *
 * Node identifier: DT_N_S_zleds_S_led_f
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_zleds_S_led_f_PATH "/zleds/led_f"

/* Node's name with unit-address: */
#define DT_N_S_zleds_S_led_f_FULL_NAME "led_f"

/* Node parent (/zleds) identifier: */
#define DT_N_S_zleds_S_led_f_PARENT DT_N_S_zleds

/* Node's index in its parent's list of children: */
#define DT_N_S_zleds_S_led_f_CHILD_IDX 5

/* Helper macros for child nodes of this node. */
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD(fn) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_zleds_S_led_f_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_zleds_S_led_f_ORD 113

/* Ordinals for what this node depends on directly: */
#define DT_N_S_zleds_S_led_f_REQUIRES_ORDS \
	11, /* /soc/gpio@50000000 */ \
	107, /* /zleds */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_zleds_S_led_f_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_zleds_S_led_f_EXISTS 1
#define DT_N_NODELABEL_ledf DT_N_S_zleds_S_led_f

/* Macros for properties that are special in the specification: */
#define DT_N_S_zleds_S_led_f_REG_NUM 0
#define DT_N_S_zleds_S_led_f_RANGES_NUM 0
#define DT_N_S_zleds_S_led_f_FOREACH_RANGE(fn) 
#define DT_N_S_zleds_S_led_f_IRQ_NUM 0
#define DT_N_S_zleds_S_led_f_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_zleds_S_led_f_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_EXISTS 1
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_PH DT_N_S_soc_S_gpio_50000000
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_VAL_pin 8
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_VAL_pin_EXISTS 1
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_VAL_flags 1
#define DT_N_S_zleds_S_led_f_P_gpios_IDX_0_VAL_flags_EXISTS 1
#define DT_N_S_zleds_S_led_f_P_gpios_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_f, gpios, 0)
#define DT_N_S_zleds_S_led_f_P_gpios_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_f, gpios, 0)
#define DT_N_S_zleds_S_led_f_P_gpios_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_f, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_f_P_gpios_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_f, gpios, 0, __VA_ARGS__)
#define DT_N_S_zleds_S_led_f_P_gpios_LEN 1
#define DT_N_S_zleds_S_led_f_P_gpios_EXISTS 1
#define DT_N_S_zleds_S_led_f_P_label "Right Green LED"
#define DT_N_S_zleds_S_led_f_P_label_STRING_TOKEN Right_Green_LED
#define DT_N_S_zleds_S_led_f_P_label_STRING_UPPER_TOKEN RIGHT_GREEN_LED
#define DT_N_S_zleds_S_led_f_P_label_FOREACH_PROP_ELEM(fn) fn(DT_N_S_zleds_S_led_f, label, 0) \
	fn(DT_N_S_zleds_S_led_f, label, 1) \
	fn(DT_N_S_zleds_S_led_f, label, 2) \
	fn(DT_N_S_zleds_S_led_f, label, 3) \
	fn(DT_N_S_zleds_S_led_f, label, 4) \
	fn(DT_N_S_zleds_S_led_f, label, 5) \
	fn(DT_N_S_zleds_S_led_f, label, 6) \
	fn(DT_N_S_zleds_S_led_f, label, 7) \
	fn(DT_N_S_zleds_S_led_f, label, 8) \
	fn(DT_N_S_zleds_S_led_f, label, 9) \
	fn(DT_N_S_zleds_S_led_f, label, 10) \
	fn(DT_N_S_zleds_S_led_f, label, 11) \
	fn(DT_N_S_zleds_S_led_f, label, 12) \
	fn(DT_N_S_zleds_S_led_f, label, 13) \
	fn(DT_N_S_zleds_S_led_f, label, 14)
#define DT_N_S_zleds_S_led_f_P_label_FOREACH_PROP_ELEM_SEP(fn, sep) fn(DT_N_S_zleds_S_led_f, label, 0) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 1) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 2) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 3) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 4) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 5) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 6) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 7) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 8) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 9) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 10) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 11) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 12) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 13) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 14)
#define DT_N_S_zleds_S_led_f_P_label_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_zleds_S_led_f, label, 0, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 1, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 2, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 3, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 4, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 5, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 6, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 7, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 8, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 9, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 10, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 11, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 12, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 13, __VA_ARGS__) \
	fn(DT_N_S_zleds_S_led_f, label, 14, __VA_ARGS__)
#define DT_N_S_zleds_S_led_f_P_label_FOREACH_PROP_ELEM_SEP_VARGS(fn, sep, ...) fn(DT_N_S_zleds_S_led_f, label, 0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 2, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 3, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 4, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 5, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 6, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 7, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 8, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 9, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 10, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 11, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 12, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 13, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep \
	fn(DT_N_S_zleds_S_led_f, label, 14, __VA_ARGS__)
#define DT_N_S_zleds_S_led_f_P_label_EXISTS 1
...
#define DT_FOREACH_OKAY_gpio_leds(fn) fn(DT_N_S_leds) fn(DT_N_S_zleds)
#define DT_FOREACH_OKAY_VARGS_gpio_leds(fn, ...) fn(DT_N_S_leds, __VA_ARGS__) fn(DT_N_S_zleds, __VA_ARGS__)
